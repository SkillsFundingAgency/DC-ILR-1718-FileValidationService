...
namespace DC.ILR.FileValidationService.Rules.Tests.FileName
{
    public class FileName_5RuleTests
    {
        ...
        public void Validate_True()
        {
            ...
            Expression<Action<IValidationErrorHandler>> handle = veh => veh.Handle("Filename_5", null, null, null);
        ...
        {
            var ilrFile = new Mock<IIlrFile>();
            ilrFile.Object.FileName = "ILR-10000532-1617-20180128-100358-10.xml";
